...
<template>
	<section id="projects" class="flex flex-col justify-center pb-[10vh]">
		<div
		...
		<div>
			<div class="flex flex-col text-stone-300">
				<div class="mb-8">
					I am currently migrating all of my old projects to a new unified AWS infrastructure. Check back soon !
				</div>
			</div>
		</div>
		</div>
